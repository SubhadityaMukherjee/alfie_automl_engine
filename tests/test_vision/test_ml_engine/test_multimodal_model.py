...
from app.vision_automl.ml_engine.model import MultimodalClassificationModel
...
def _build_model(
    ...
    with (
        ...
        patch(
            "app.vision_automl.ml_engine.model.AutoModelForImageClassification.from_pretrained",
